...
export interface Metric {
  ...
  name: 'CLS' | 'FCP' | 'FID' | 'INP' | 'LCP' | 'TTFB' | 'RESOURCE';
   ...
   */
  // 2023-02-01: Amazon addition.
  entries: (PerformanceResourceTiming | PerformanceEntry | LayoutShift | FirstInputPolyfillEntry | NavigationTimingPolyfillEntry)[];
